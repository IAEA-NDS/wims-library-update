...
C
      ...
      END DO
C
C  4) CALCUL MEAN VALUE OF FINE STRUCTURE OF THERMAL NEUTRON FLUX DIST.
...
C
      ...
      WRITE(2,400)' Ai:Annulus i;Mj:Moderator (j:cm) '
      WRITE(2,400)' ================================='
      WRITE(2,401)' Case  COO  A1   DIF.%  A2   DIF.% A3NG  DIF.% A3WG
     1DIF.%  M11  DIF.%  M16  DIF.%  M22  DIF.% '
      WRITE(2,401)' ====================================================
     1=========================================='
      WRITE(2,500)(FFRE(I,1),(FFRE(19,1)*100.0/FFRE(I,1)),I=1,3),
     1 FFRE(7,1),(FFRE(19,1)*100.0/FFRE(7,1)),
     2 FFRE(12,1),(FFRE(19,1)*100.0/FFRE(12,1)),
     3 FFRE(18,1),(FFRE(19,1)*100.0/FFRE(18,1))
      WRITE(2,503)(FFR(I,1),(FFRR(I,1)*100.0/FFR(I,1)),I=1,3),
     1 FFR(7,1),(FFRR(7,1)*100.0/FFR(7,1)),
     2 FFR(12,1),(FFRR(12,1)*100.0/FFR(12,1)),
     3 FFR(18,1),(FFRR(18,1)*100.0/FFR(18,1))
      WRITE(2,402)'          '
C
      WRITE(2,501)(FFRE(I,2),(FFRE(19,1)*100.0/FFRE(I,2)),I=1,3),
     1 FFRE(7,2),(FFRE(19,1)*100.0/FFRE(7,2)),
     2 FFRE(12,2),(FFRE(19,1)*100.0/FFRE(12,2)),
     3 FFRE(18,2),(FFRE(19,1)*100.0/FFRE(18,2))
      WRITE(2,503)(FFR(I,2),(FFRR(I,2)*100.0/FFR(I,2)),I=1,3),
     1 FFR(7,2),(FFRR(7,2)*100.0/FFR(7,2)),
     2 FFR(12,2),(FFRR(12,2)*100.0/FFR(12,2)),
     3 FFR(18,2),(FFRR(18,2)*100.0/FFR(18,2))
      WRITE(2,402)'          '
C
      WRITE(2,502)(FFRE(I,3),(FFRE(18,3)*100.0/FFRE(I,3)),I=1,2),
     1 FFRE(4,3),(FFRE(18,3)*100.0/FFRE(4,3)),
     2 FFRE(8,3),(FFRE(18,3)*100.0/FFRE(8,3)),
     3 FFRE(13,3),(FFRE(18,3)*100.0/FFRE(13,3)),
     4 FFRE(17,3),(FFRE(18,3)*100.0/FFRE(17,3))
      WRITE(2,504)(FFR(I,3),(FFRR(I,3)*100.0/FFR(I,3)),I=1,2),
     1 FFR(4,3),(FFRR(4,3)*100.0/FFR(4,3)),
     2 FFR(8,3),(FFRR(8,3)*100.0/FFR(8,3)),
     3 FFR(13,3),(FFRR(13,3)*100.0/FFR(13,3)),
     4 FFR(17,3),(FFRR(17,3)*100.0/FFR(17,3))
      WRITE(2,402)'          '
      WRITE(2,401)' ====================================================
     1=========================================='
C
 ...
 401  FORMAT(A95)
 402  FORMAT(A10)
 500  FORMAT(' Gd:NO  H2O',3(F5.2,'(',F6.1,')'),12X,3(F5.2,'(',F5.1,')')
     1)
 501  FORMAT(' Gd:NO  AIR',3(F5.2,'(',F6.1,')'),12X,3(F5.2,'(',F5.1,')')
     1)
 502  FORMAT(' Gd:YES H2O',2(F5.2,'(',F6.1,')'),12X,4(F5.2,'(',F5.1,')')
     1)
 503  FORMAT('           ',3(F5.2,'(',F6.1,')'),12X,3(F5.2,'(',F5.1,')')
     1)
 504  FORMAT('           ',2(F5.2,'(',F6.1,')'),12X,4(F5.2,'(',F5.1,')')
     1)
C *****************************
C
C FIGURE 1A
C
      ...
      WRITE(2,600)' ==================================================='
      WRITE(2,601)' R(cm)     FLUX   DIF.% '
      WRITE(2,601)' ======================='
      DO I=1,18
       WRITE(2,700)RADIO(I,1),FFRE(I,1),(EXPERR*100.0/FFRE(I,1))
       WRITE(2,701)FFR(I,1),(FFRR(I,1)*100.0/FFR(I,1))
       WRITE(2,402)'          '
      END DO
      WRITE(2,601)' ======================='
C
...
C
      ...
      WRITE(2,601)' ======================='
      DO I=1,18
       WRITE(2,700)RADIO(I,1),FFRE(I,2),(EXPERR*100.0/FFRE(I,2))
       WRITE(2,701)FFR(I,2),(FFRR(I,2)*100.0/FFR(I,2))
       WRITE(2,402)'          '
      END DO
      WRITE(2,601)' ======================='
C
...
C
      ...
      WRITE(2,601)' ======================='
      DO I=1,2
       WRITE(2,700)RADIO(I,3),FFRE(I,3),(EXPERR*100.0/FFRE(I,3))
       WRITE(2,701)FFR(I,3),(FFRR(I,3)*100.0/FFR(I,3))
       WRITE(2,402)'          '
      END DO
      DO I=4,17
       WRITE(2,700)RADIO(I,3),FFRE(I,3),(EXPERR*100.0/FFRE(I,3))
...
C
      ...
      WRITE(2,600)' ==================================================='
      WRITE(2,601)' Case      Dy-RR  DIF.% '
      WRITE(2,601)' ======================='
C
      WRITE(2,801)FFRE(1,7),(FFRE(5,7)*100.0/FFRE(1,7))
      WRITE(2,805)FFR(33,4),(FFRR(33,4)*100.0/FFR(33,4))
      WRITE(2,402)'          '
C
      WRITE(2,802)FFRE(2,7),(FFRE(6,7)*100.0/FFRE(2,7))
      WRITE(2,805)FFR(33,5),(FFRR(33,5)*100.0/FFR(33,5))
      WRITE(2,402)'          '
C
      WRITE(2,803)FFRE(3,7),(FFRE(7,7)*100.0/FFRE(3,7))
      WRITE(2,805)FFR(33,6),(FFRR(33,6)*100.0/FFR(33,6))
      WRITE(2,402)'          '
C
      WRITE(2,804)FFRE(4,7),(FFRE(8,7)*100.0/FFRE(4,7))
      WRITE(2,805)FFR(33,7),(FFRR(33,7)*100.0/FFR(33,7))
      WRITE(2,402)'          '
C
      WRITE(2,601)' ======================='
C
